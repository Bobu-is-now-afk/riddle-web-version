...
- **Five Souls, One Diary:** Each time you open the diary, one of five spirits possesses it at random — **Tom Riddle** (eerie, charming, subtly probing), **Dumbledore** (warm, wise, answers with questions), **Snape** (curt, sardonic), **Luna Lovegood** (dreamy, kind, Wrackspurt-aware), or the **Marauder's Map** (collective mischief from Messrs Moony, Wormtail, Padfoot & Prongs). Each writes in their own ink colour, their name appears faintly in the corner, and every reply comes in the language you wrote in. Pin a favourite — or return to 🎲 random — in the ⚙ settings.
